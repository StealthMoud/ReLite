...
- **Samsung One UI** — ReLite Home is "inspired by" One UI ergonomics
  (spacing, one-handed reach, rounded geometry) as a design philosophy
  only. No Samsung assets, icons, fonts, wallpapers, animations, or
  artwork are used or redistributed anywhere in this project.
